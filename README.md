...
Code powering https://grantismo.github.io/BlorpppppRanking/#/
...
* [[src/](https://github.com/Grantismo/BlorpppppRanking/tree/main/src)] A static react website which displays player data 
* [[cron/](https://github.com/Grantismo/BlorpppppRanking/tree/main/cron)] A cron job which pulls tournament data from [CO Melee Braacket](https://braacket.com/league/comelee), calculates colley scores and tabulates head-to-heads in `cron/data/`, and then redeploys the static site (and automatically configures github pages for you on the first deploy).
...
- (Optional) Run `nvm use 22.12.0`. This will ensure that you are running the supported version of Node.js.
...
### Test the web app
- Run `npm start` and open http://localhost:8262/ in your browser.
